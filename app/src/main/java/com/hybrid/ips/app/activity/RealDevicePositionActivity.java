...
public class RealDevicePositionActivity extends AppCompatActivity
{
    ...
    public void determineLocation()
    {
        ...
        try
        {
            ...
            final Location calculatedLocation = new Location(UUID.randomUUID().toString(), fId, centroid[0], centroid[1], findRealDeviceArea(centroid[0], centroid[1]),currentDate);
            realm.executeTransaction(new Realm.Transaction()
            {
                @Override
                public void execute(Realm bgRealm)
    ...
    public String findRealDeviceArea(double x,double y)
    {
        String area="N/A";
        //HALL
